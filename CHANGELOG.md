# v0.8.9 (Wed Jan 24 2024)

#### :wrench: Improvement

- build(deps-dev): bump vite from 4.3.9 to 4.5.2 [#93](https://github.com/oskar-gmerek/oskargmerek.com/pull/93) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- ops: change `user` ([@oskar-gmerek](https://github.com/oskar-gmerek))
...
- improve: drop pre-releases [#33](https://github.com/oskar-gmerek/oskargmerek.com/pull/33) ([@oskar-gmerek](https://github.com/oskar-gmerek))
